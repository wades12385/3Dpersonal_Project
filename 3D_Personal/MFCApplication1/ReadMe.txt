...
MFCApplication1.h
    ...
    여기에는 resource.h를 비롯한 다른 프로젝트별 헤더가 포함되어 있으며 CMFCApplicationApp 응용 프로그램 클래스가 선언되어 있습니다.

MFCApplication1.cpp
    이는 응용 프로그램 클래스 CMFCApplicationApp가 포함된 기본 응용 프로그램 소스 파일입니다.
...
MFCApplication1Doc.h, MFCApplication1Doc.cpp - 문서
    이 파일에는 CMFCApplicationDoc 클래스가 포함됩니다. 이 파일을 편집하여 특수 문서 데이터를 추가하고 CMFCApplicationDoc::Serialize를 통해 파일 저장 및 로드를 구현합니다.

MFCApplication1View.h, MFCApplication1View.cpp - 문서 뷰
    이 파일에는 CMFCApplicationView 클래스가 포함됩니다.
    CMFCApplicationView 개체는 CMFCApplicationDoc 개체를 보는 데 사용됩니다.
